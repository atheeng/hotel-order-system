...
import com.dao.daoImpl.FoodDaoImpl;
import com.dto.OrderListDto;
import com.dto.OrderModelTable;
import com.dto.FoodModelTable;
...
public class Dashboard extends javax.swing.JFrame {
    ...
    public void loadTableFoodItem() {
        FoodDao pd = new FoodDaoImpl();
        List<Food> list = pd.getAllFood();
        FoodModelTable model = new FoodModelTable(list);
    ...
    public void resetProductForm() {
        ...
        txt_food_name.setEditable(true);
        txt_food_price.setText(null);
        txt_food_quantity.setText(null);
        cb_food_category.setSelectedIndex(0);
        cb_food_category.setEnabled(true);
        txt_food_description.setText("");
        txt_food_id = 0;
        radio_btn_today.setSelected(false);
    }
    ...
    private void initComponents() {
        ...
        txt_food_name = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        jLabel17 = new javax.swing.JLabel();
        txt_food_quantity = new javax.swing.JTextField();
        cb_food_category = new javax.swing.JComboBox<>();
        jLabel18 = new javax.swing.JLabel();
        jLabel19 = new javax.swing.JLabel();
        txt_food_price = new javax.swing.JTextField();
        product_save_update = new javax.swing.JButton();
        product_delete = new javax.swing.JButton();
        jScrollPane4 = new javax.swing.JScrollPane();
        txt_food_description = new javax.swing.JTextArea();
        reset_product = new javax.swing.JButton();
        jLabel11 = new javax.swing.JLabel();
        radio_btn_today = new javax.swing.JRadioButton();
        ...
        menuTab.addTab("User", customer_panel);

        productPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Food Item Form"));

        jLabel15.setText("Name");

        txt_food_name.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_food_nameActionPerformed(evt);
            }
        });
        ...
        cb_food_category.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Cetegory", "TEA", "COFFE", "SNACK", "BREAK FAST", "KHAJA", "LUNCH", "DINNER", " ", " " }));
        ...
        txt_food_description.setColumns(20);
        txt_food_description.setRows(5);
        jScrollPane4.setViewportView(txt_food_description);
        ...
        radio_btn_today.setText("Set Today in Food List");
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_food_name)
                            .addComponent(txt_food_quantity)
                            .addComponent(cb_food_category, javax.swing.GroupLayout.Alignment.TRAILING, 0, 146, Short.MAX_VALUE)
                            .addComponent(txt_food_price)
                            .addComponent(jScrollPane4, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                            .addComponent(radio_btn_today, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cb_food_category, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_food_name, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15))
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel17)
                    .addComponent(txt_food_quantity, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(21, 21, 21)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(txt_food_price, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        product_search_panel.setBorder(javax.swing.BorderFactory.createTitledBorder("Item Details"));
        ...
        product_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Category", "Quantity", "Price", "Description", "Today "
            }
        ));
        ...
        menuTab.addTab("Food", productPanel);
        ...
        menuTab.addTab("OrderFood", jPanel3);
        ...
        order_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order By", "Order No.", "No. of Items", "Total Amt.", "Order Date", "Status", "Action"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    private void order_add_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_order_add_updateActionPerformed
        ...
        tempOrder.setFoodId(Integer.parseInt(id[0]));
    ...
    private void txt_order_itemsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_txt_order_itemsItemStateChanged
        ...
        FoodDao pd = new FoodDaoImpl();
        String id[] = item.split("-");
        Food product = pd.getById(Integer.parseInt(id[0]));
    ...
    private void product_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_product_searchActionPerformed
        ...
        FoodDao pd = new FoodDaoImpl();
        List<Food> list = pd.getAllProductSearch(name, type);
        FoodModelTable model = new FoodModelTable(list);
        product_table.setModel(model);
    ...
    private void product_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_product_tableMouseClicked
        // TODO add your handling code here:
        txt_food_id = Integer.parseInt(product_table.getValueAt(product_table.getSelectedRow(), 0).toString());
        FoodDao pd = new FoodDaoImpl();
        Food food = pd.getById(txt_food_id);
        txt_food_name.setText(food.getName());
        txt_food_name.setEditable(false);
        cb_food_category.setSelectedItem(food.getCategory().toString());
        cb_food_category.setEnabled(false);
        String qty = String.valueOf(food.getTotalQty());
        txt_food_quantity.setText(qty);
        String price = String.valueOf(food.getPrice());
        txt_food_price.setText(price);
        if (food.isTodaySet() == true) {
            radio_btn_today.setSelected(true);
        } else {
            radio_btn_today.setSelected(false);
        }
    ...
    private void product_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_product_deleteActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null, "Do you want to proceed?", "Confirm...",
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
        if (input == 0) {
            int productId = txt_food_id;
            FoodDao productDao = new FoodDaoImpl();
    ...
    private void product_save_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_product_save_updateActionPerformed
        ...
        int foodId = txt_food_id;
        String foodName = txt_food_name.getText().trim();
        if (foodName.length() == 0) {
            JOptionPane.showMessageDialog(null, "food name is required", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        String foodCategory = cb_food_category.getSelectedItem().toString();
        if (foodCategory == "Select Type") {
            JOptionPane.showMessageDialog(null, "food type is required", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Integer qty = null;
        if ((txt_food_quantity.getText().trim()).length() == 0) {
            JOptionPane.showMessageDialog(null, "food quantity is required", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            try {
                qty = Integer.parseInt(txt_food_quantity.getText());
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "food quantity should be numeric", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }
        }
        Double price = null;
        if ((txt_food_price.getText().trim()).length() == 0) {
            JOptionPane.showMessageDialog(null, "food price is required", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            try {
                price = Double.parseDouble(txt_food_price.getText());
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "food price should be numeric ", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }
        }
        ...
        boolean today = radio_btn_today.isSelected();

        Food food;
        FoodDao foodDao = new FoodDaoImpl();
        if (foodId == 0) {
            food = new Food(foodName, foodCategory, price, qty, description, today);
        } else {
            ...
            food.setPrice(price);
            food.setTotalQty(qty);
            food.setDescription(description);
            food.setTodaySet(today);
        }
        String result = foodDao.saveUpdate(food);
        JOptionPane.showMessageDialog(null, result, "Success", JOptionPane.WARNING_MESSAGE);
        resetProductForm();
        txt_food_name.setEditable(true);
        cb_food_category.setEnabled(true);
...
//        foodItemList()
    ...
    private void txt_food_nameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_food_nameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_food_nameActionPerformed
    ...
    private void order_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_order_tableMouseClicked
        ...
        OrderDao od = new OrderDaoImpl();
        if (user.getRole().toString() != "CUSTOMER") {
            String[] buttons = {"PROGRESS", "DELIVERY", "DETAIL", "CANCEL"};
            int rc = JOptionPane.showOptionDialog(null, "WHAT DO YOU WANT???", "Confirmation",
                    JOptionPane.WARNING_MESSAGE, 0, null, buttons, buttons[2]);
            if (rc == 0) {
                od.updateStatus(orderNo, 0);
                loadOrderListTable();
            } else if (rc == 1) {
                od.updateStatus(orderNo, 1);
                loadOrderListTable();
            } else if (rc == 2) {
    ...
    private javax.swing.JComboBox<String> cb_food_category;
    ...
    private javax.swing.JRadioButton radio_btn_today;
    ...
    private javax.swing.JTextArea txt_food_description;
    private javax.swing.JTextField txt_food_name;
    private javax.swing.JTextField txt_food_price;
    private javax.swing.JTextField txt_food_quantity;
